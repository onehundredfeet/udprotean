...
class TestSequentialCommunication extends SequentialCommunication implements ITest
{
    static final SequenceSize = SequentialCommunication.SequenceSize;
    static final SequenceBytes = SequentialCommunication.SequenceBytes;
